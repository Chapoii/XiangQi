...
window.onload = function(){
	...
	com.get("stypeBtn").addEventListener("click", function(e) {
		...
		stype = 'stype'+(parseInt(stype.charAt(5)) % 3 +1)
		com.init(stype);
		com.show();
		//play.depth = 4;
		//play.init();
	...
	com.getData("/static/chess/js/gambit.all.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "/static/chess/img/"+stype+"/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "/static/chess/img/"+stype+"/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "/static/chess/img/"+stype+"/"+ com.args[i].img +".png";
		//com[i].img.src = "img/"+stype+"/r_m.png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "/static/chess/img/"+stype+"/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(/static/chess/img/"+stype+"/bg.jpg)";
...
com.args={
	...
	'j':{text:"帅", img:'r_j', my:1 ,bl:"j", value:com.value.j},
	...
	'J':{text:"将", img:'b_j', my:-1 ,bl:"j", value:com.value.J},
	'P':{text:"砲", img:'b_p', my:-1 ,bl:"p", value:com.value.P},
